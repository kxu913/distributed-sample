...
public class SecondKillServiceImpl implements SecondKillService {
    ...
    @Autowired private RedisTemplate<Long, JSONObject> jsonRedisTemplate;
    @Autowired private RedisTemplate<Long, String> longStringRedisTemplate;
    @Autowired private RestTemplate restTemplate;

    @Autowired private RocketMQTemplate rocketMQTemplate;

    @Value("${rocketmq.topic}") private String shoppingTopic;
